...
class TestOutputEx1(unittest.TestCase):
    ...
    def test__frequencies(self):
        self.assertEqual(ex1_1.frequencies("ex1/inputs/inputDavid1.txt"), 569)
        self.assertEqual(ex1_1.frequencies("ex1/inputs/inputDavid2.txt"), 4)
        self.assertEqual(ex1_1.frequencies("ex1/inputs/inputDavid3.txt"), 4)
        self.assertEqual(ex1_1.frequencies("ex1/inputs/inputDavid4.txt"), 1)
