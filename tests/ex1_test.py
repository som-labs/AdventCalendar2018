...
class TestStringMethods(unittest.TestCase):
	...
	def test_cadena2(self):
        ...
        self.assertEqual(ex1_2.ex1_2("ex1/inputs/inputDavid1.txt"), 77666)
        self.assertEqual(ex1_2.ex1_2("ex1/inputs/inputDavid2.txt"), 10)
        self.assertEqual(ex1_2.ex1_2("ex1/inputs/inputDavid3.txt"), 5)
        self.assertEqual(ex1_2.ex1_2("ex1/inputs/inputDavid4.txt"), 14)
